 ...
 * @author tog
 */
public class RightWall extends AbstractGlobalForce
{
    ...
    public RightWall(G2D g2d, Iterable<? extends ForceReceiverPoint> globalList, float springConstant, float dampingConstant, float pos)
    {
        super(globalList);
        this.g2d = g2d;
